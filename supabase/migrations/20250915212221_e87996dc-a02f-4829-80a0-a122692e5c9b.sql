...
-- Create admin analytics function instead of view
...
AS $$
  SELECT 
    ...
    (SELECT COUNT(*) FROM public.vendors WHERE is_active = true)::BIGINT,
    ...
    (SELECT COUNT(*) FROM public.vendors WHERE is_verified = false)::BIGINT;
$$;
